...
const Courses = () => {
  ...
  const [enrolledCourses, setEnrolledCourses] = useState([
    {
      ...
      students: 45,
      description:
        "Master fundamental data structures and algorithms essential for computer science.",
      topics: [
        "Arrays",
        "Linked Lists",
        "Trees",
    ...
    },
    {
      ...
      students: 42,
      description:
        "Learn modern web development technologies including HTML, CSS, JavaScript, and React.",
  ...
  const handleEnroll = (course: any) => {
    setEnrolledCourses([...enrolledCourses, { ...course, progress: 0, completedHours: 0, completed: false }]);
    setAvailableCourses(availableCourses.filter((c) => c.id !== course.id));
    alert(`✅ Successfully Enrolled in ${course.title}`);
  };

  // ✅ View Certificate Function
  const handleCertificate = (course: any) => {
    navigate(`/certificates?course=${encodeURIComponent(course.title)}&instructor=${encodeURIComponent(course.instructor)}`);
  };
